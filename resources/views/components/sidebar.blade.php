<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="sidenav-footer mx-3 ">
      ...
      <a class="btn mt-3 w-100" href="https://www.creative-tim.com/product/soft-ui-dashboard-pro?ref=sidebarfree" style="background-color: #106694; border-color: #106694; color: #fff;">Upgrade to pro</a>
    </div>    
  </aside>