      ...
      <div class="col-lg-6 col-12">
        <div class="row">
          <div class="col-lg-6 col-md-6 col-12">
            <div class="card">
              <span class="mask border-radius-lg" style="background-color: #a1dbf6; opacity: 100;"></span>
          ...
          <div class="col-lg-6 col-md-6 col-12 mt-4 mt-md-0">
            <div class="card">
              <span class="mask border-radius-lg" style="background-color: #106694 ; opacity: 100;"></span>
              <div class="card-body p-3 position-relative">
                <div class="row">
                  <div class="col-8 text-start">
                    <div class="icon icon-shape bg-white shadow text-center border-radius-2xl">
              ...
              <div class="card-body p-3 position-relative">
                <div class="row">
                  <div class="col-8 text-start">
                    ...
                    <span class="text-white text-sm">Pesanan</span>
                  </div>
                  <div class="col-4">
                    <div class="dropstart text-end mb-6">
          ...
          <div class="card-body pb-0 p-3">
            <ul class="list-group">
              <li class="list-group-item border-0 d-flex align-items-center px-0 mb-0">
                <div class="w-100">
                  <div class="d-flex mb-2">
                    <span class="me-2 text-sm font-weight-bold text-dark">Malang</span>
                    <span class="ms-auto text-sm font-weight-bold">80%</span>
                  </div>
                  <div>
                    <div class="progress progress-md">
                      <div class="progress-bar" style="background-color: #C1E4F4; width:80%" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </li>
              <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                <div class="w-100">
                  <div class="d-flex mb-2">
                    <span class="me-2 text-sm font-weight-bold text-dark">Gresik</span>
                    <span class="ms-auto text-sm font-weight-bold">17%</span>
                  </div>
                  <div>
                    <div class="progress progress-md">
                      <div class="progress-bar" style="background-color: #C1E4F4; width:17%" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </li>
              <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                <div class="w-100">
                  <div class="d-flex mb-2">
                    <span class="me-2 text-sm font-weight-bold text-dark">Lamongan</span>
                    <span class="ms-auto text-sm font-weight-bold">44%</span>
                  </div>
                  <div>
                    <div class="progress progress-md">
                      <div class="progress-bar" style="background-color: #C1E4F4; width:44%" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </li>
              <li class="list-group-item border-0 d-flex align-items-center px-0 mb-0">
                <div class="w-100">
                  <div class="d-flex mb-2">
                    <span class="me-2 text-sm font-weight-bold text-dark">Tuban</span>
                    <span class="ms-auto text-sm font-weight-bold">37%</span>
                  </div>
                  <div>
                    <div class="progress progress-md">
                      <div class="progress-bar" style="background-color: #C1E4F4; width:37%" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </li>
            </ul>
