            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
                        ...
                        <p>Bersama Banyu Bancar, perjalanan bukan sekadar perjalanan ini tentang kenyamanan dan kepercayaan
                        </p>
                        <div class="d-flex">
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                        <p> Banyu Bancar, di bawah naungan PT Banyu Bancar Nusantara, telah menjadi pilihan utama dalam
                            layanan travel dan transportasi
                            sejak 2014. Dengan pengalaman lebih dari satu dekade, kami berkomitmen memberikan layanan antar
                            jemput langsung sesuai alamat
                            yang nyaman, efisien, dan tepat waktu. Kami melayani rute <strong>Malang – Gresik – Lamongan –
                                Tuban (PP)</strong> dengan armada
                            Toyota Hiace dan Innova Reborn yang selalu prima, didukung sopir berpengalaman untuk memastikan
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="200">
                        <div class="service-item position-relative">
                            ...
                            <h4><a href="" class="stretched-link">2. Isi Formulir Pemesanan dengan Data yang
                                    Benar</a></h4>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="team-member d-flex align-items-start">
                            <div class="pic"><img src="assets/img/team/team-1.jpg?v=2" class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Travel</h4>
                                <p>Layanan travel kami menyediakan transportasi antar-jemput dengan armada yang nyaman, siap
                                    mengantar Anda dengan aman.</p>
                            </div>
                        </div>
                    </div><!-- End Team Member -->
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="team-member d-flex align-items-start">
                            <div class="pic"><img src="assets/img/team/team-2.jpg?v=2" class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Kirim Paket/Barang</h4>
                                <p>Kami juga melayani pengiriman paket. Layanan ini memastikan paket Anda sampai tujuan
                                    dengan cepat, aman, dan terpercaya.</p>
                            </div>
                        </div>
                    </div><!-- End Team Member -->
                </div>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-in" data-aos-delay="100">
                        <div class="pricing-item"
                            style="background: linear-gradient(rgba(255, 255, 255, 1), rgba(124, 126, 209, 0.7)),url('assets/img/jadwal-bg.jpeg'); background-size: cover; background-position: center;"">
                            <h3>Tuban - Malang</h3>
                            ...
                            <ul>
                                ...
                                <li><i class="bi bi-check"></i> <span>Penjemputan area Malang yaitu Rampal, Sulfat,
                                        Sawojajar, Suhat, Pakis, Wendit, Arjosari</span></li>
                        ...
                        <div class="faq-container">
                            ...
                            <div class="faq-item faq-active" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div class="faq-content">
                                    <p>Kami melayani rute perjalanan Malang – Gresik – Lamongan – Tuban (PP) dengan layanan
                                        antar jemput langsung sesuai alamat.
                                    <p>
                                </div>
                            ...
                            <div class="faq-item" data-aos="fade-up" data-aos-delay="300">
                                ...
                                <div class="faq-content">
                                    <p>Kami menggunakan armada yang nyaman dan berkualitas, yaitu Toyota Hiace dan Innova
                                        Reborn, yang selalu dalam kondisi prima
                            ...
                            <div class="faq-item" data-aos="fade-up" data-aos-delay="400">
                                ...
                                <div class="faq-content">
                                    <p>Anda dapat memesan tiket melalui website kami atau langsung menghubungi layanan
                                        pelanggan. Cukup isi formulir
                                        pemesanan, unggah bukti transfer, dan konfirmasi pemesanan. Setelah pembayaran
                                        diverifikasi, tiket dapat dicetak.
                                    </p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            </div><!-- End Faq item-->
                            ...
                            <div class="faq-item" data-aos="fade-up" data-aos-delay="500">
                                ...
                                <h3>Apakah ada batasan jumlah bagasi yang diperbolehkan?<h3>
                                        <div class="faq-content">
                                            <p>Setiap penumpang diperbolehkan membawa bagasi dengan ukuran dan berat yang
                                                wajar. Jika melebihi batas wajar,
                                                akan dikenakan biaya tambahan. Untuk informasi lebih lanjut mengenai batasan
                                                bagasi dan biaya tambahan,
                            ...
                            <div class="faq-item" data-aos="fade-up" data-aos-delay="600">
                                ...
                                <div class="faq-content">
                                    <p>Saat ini, kami hanya melayani rute utama Malang – Gresik – Lamongan – Tuban (PP).
                                        Namun, untuk kebutuhan perjalanan
                                        khusus atau charter, Anda dapat menghubungi pihak travel untuk informasi lebih
            ...
            <div class="container">
                <div class="row" data-aos="zoom-in" data-aos-delay="100">
                    <div class="col-xl-9 text-center text-xl-start">
                        ...
                        <p>Jika ingin memesan atau bertanya lebih lanjut, silakan hubungi kami melalui WhatsApp Business.
                        </p>
                    </div>
                    <div class="col-xl-3 cta-btn-container text-center">
                        <a class="cta-btn align-middle" href="https://wa.me/6282140490944" target="_blank">Hubungi via
                            WhatsApp</a>
                    </div>
                </div>
            </div>
