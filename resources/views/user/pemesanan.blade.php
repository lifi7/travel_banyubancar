  ...
  <main class="main">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              ...
              <div class="carousel-item">
                <img class="d-block w-100" src="assets/img/bg1.jpg" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="assets/img/bg1.jpg" alt="Third slide">
              </div>
            </div>
          </div>
      </div>
    ...
    <section id="pricing" class="pricing section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Travel</h2>
        <p>Harga menyesuaikan dengan tujuan perjalanan anda</p>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-in" data-aos-delay="100">
            <div class="pricing-item"  style="background: linear-gradient(rgba(255, 255, 255, 1), rgba(124, 126, 209, 0.7)),url('assets/img/jadwal-bg.jpeg'); background-size: cover; background-position: center;"">
              ...
              <a href="{{ url('/form travel') }}" class="buy-btn">Booking</a>
            </div>
        ...
        <section id="pricing" class="pricing section">
            ...
            <!-- Section Title -->
            <div class="container section-title" data-aos="fade-up">
              <h2>Kirim Paket/Barang</h2>
              <p>Harga menyesuaikan dengan berat dan jenis barang</p>
            </div><!-- End Section Title -->
            ...
            <div class="container">
              ...
              <div class="row gy-4">
                ...
                <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-in" data-aos-delay="100">
                  <div class="pricing-item"  style="background: linear-gradient(rgba(255, 255, 255, 1), rgba(124, 126, 209, 0.7)),url('assets/img/jadwal-bg.jpeg'); background-size: cover; background-position: center;"">
                    <h3>Tuban - Malang</h3>
                    <h4><sup>Rp</sup>80.000<span> / <del>200.000</del></span></h4>
                    <ul>
                      <li><i class="bi bi-check"></i> <span>Pemberangkatan pukul 07:00 - 08:00 WIB</span></li>
                      <li><i class="bi bi-check"></i> <span>Penjemputan area Malang yaitu Rampal, Sulfat, Sawojajar, Suhat, Pakis, Wendit, Arjosari</span></li>
                      <li><i class="bi bi-check"></i> <span>Kapasitas Armada 8-12 penumpang</span></li>
                    </ul>
                    <a href="{{ url('/form kirimbarang') }}" class="buy-btn">Booking</a>
                  </div>
                </div><!-- End Pricing Item -->
