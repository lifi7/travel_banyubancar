                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="team-member d-flex align-items-start"
                            onclick="window.location.href='riwayatpemesanantravel' " style="cursor: pointer;">
                            <div class="pic"><img src="assets/img/team/team-1.jpg?v=2" class="img-fluid"
                                    alt=""></div>
                            <div class="member-info">
                                <h4>Travel</h4>
                                <p>Layanan travel kami menyediakan transportasi antar-jemput dengan armada yang nyaman,
                                    siap mengantar Anda dengan aman.</p>
                            </div>
                        </div>
                    </div><!-- End Team Member -->
